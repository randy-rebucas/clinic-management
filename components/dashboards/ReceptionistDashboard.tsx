        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="bg-white rounded-lg border border-gray-200 px-4 py-3">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h1 className="text-base font-semibold text-gray-900">Receptionist Dashboard</h1>
                  <p className="text-xs text-gray-500">Front desk operations and scheduling overview</p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-3">
            {statCards.map((card: any, index: number) => {
              ...
              return (
                <Link key={`${card.title}-${card.href}-${index}`} href={card.href} className="group">
