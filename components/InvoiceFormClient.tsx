          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-3xl sm:text-4xl font-bold text-gray-900">New Invoice</h1>
                  <p className="text-sm sm:text-base text-gray-600 mt-1">Create a new invoice for billing</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            {submitting ? (
              <div className="flex flex-col items-center gap-4 min-h-[200px] justify-center p-12">
                ...
                <p className="text-sm text-gray-600 font-medium">Creating invoice...</p>
              </div>
            ) : (
              <InvoiceForm
