...
export const metadata: Metadata = {
  title: 'Contact Us - MyClinicSoft',
  description: 'Get in touch with MyClinicSoft. We\'re here to help with any questions or support needs.',
};
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-lg">
              ...
              <form className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl font-semibold hover:from-blue-700 hover:to-indigo-700 transition-all shadow-lg hover:shadow-xl transform hover:scale-105"
                >
                  Send Message
                </button>
              </form>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:support@myclinicsoft.com" className="text-blue-600 hover:text-blue-700">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-lg">
                ...
                <div className="space-y-2 text-gray-600">
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-200">
                    <p className="text-sm">
                      <span className="font-semibold">Enterprise customers:</span> 24/7 support available
                    </p>
                  </div>
                </div>
              </div>
