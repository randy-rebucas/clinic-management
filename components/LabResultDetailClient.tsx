      ...
      <section className="py-6 px-4 sm:px-6 bg-gray-50 min-h-screen">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col items-center gap-4 min-h-[50vh] justify-center">
            ...
            <p className="text-sm text-gray-500">Loading lab result...</p>
          </div>
        </div>
      </section>
    );
      ...
      <section className="py-6 px-4 sm:px-6 bg-gray-50 min-h-screen">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col items-center gap-4 min-h-[50vh] justify-center">
            ...
            <h2 className="text-base font-semibold text-gray-900">Lab result not found</h2>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5 sm:p-8">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-base font-semibold text-gray-900">{labResult.requestCode || 'Lab Order'}</h1>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-sm font-semibold text-gray-900">Test Request</h3>
              </div>
              <div className="flex flex-col gap-4">
                <div>
                ...
                <div className="flex flex-col gap-3">
                  {typeof labResult.results === 'object' && labResult.results !== null ? (
                    Object.entries(labResult.results).map(([key, value]) => {
                      ...
                      return (
                        <div key={key} className="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition-all">
            ...
            {labResult.thirdPartyLab && (
              <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-sm font-semibold text-gray-900">Third Party Lab</h3>
                </div>
            ...
            {labResult.visit && (
              <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-sm font-semibold text-gray-900">Related Visit</h3>
                </div>
                <Link 
