        ...
        <div className="flex flex-col gap-6 p-4 sm:p-6">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-5">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-sm font-semibold text-gray-900">Patient & Visit</h3>
            </div>
            <div className="flex flex-col gap-4">
              {/* Patient Selection */}
          ...
          {formData.category === 'imaging' && (
            <div className="bg-white border border-gray-200 rounded-xl p-5">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-sm font-semibold text-gray-900">Imaging Information</h3>
              </div>
              <div className="flex flex-col gap-4">
                <div>
          ...
          {formData.category === 'medical_certificate' && (
            <div className="bg-white border border-gray-200 rounded-xl p-5">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-sm font-semibold text-gray-900">Medical Certificate Information</h3>
              </div>
              <div className="flex flex-col gap-4">
                <div>
          ...
          {formData.category === 'laboratory_result' && (
            <div className="bg-white border border-gray-200 rounded-xl p-5">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-sm font-semibold text-gray-900">Laboratory Result Information</h3>
              </div>
              <div className="flex flex-col gap-4">
                <div>
          ...
          <div className="flex justify-end gap-3 pt-2">
            ...
            <button type="submit" className="px-4 py-2.5 text-sm bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors font-semibold">
              Upload Document
            </button>
          </div>
        </div>
