    ...
    <form action={action} className="space-y-5">
      ...
      <div>
        ...
        <select
          id="role"
          name="role"
          className="w-full px-2.5 py-1.5 border border-gray-200 rounded-md text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white"
          defaultValue="user"
        >
