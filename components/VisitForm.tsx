            ...
            <div className="border-b border-gray-200 bg-gray-50/50">
              <div className="flex">
                <button
                  ...
                  className={`px-6 py-3 border-b-2 transition-all relative text-sm font-semibold ${
                    activeTab === 'soap'
                  ...
                  <div key={index} className="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition-all">
                    <div className="flex flex-col md:flex-row gap-4 flex-wrap">
                        <div className="flex-1 relative" style={{ minWidth: '200px' }}>
                          <label className="block text-xs font-semibold text-gray-700 mb-2">ICD-10 Code</label>
